...
//player createDiarySubject ["3rd AD","3rd Armored Division"];
...
player createDiaryRecord["Diary", ["Situation", "Friendly<br/>4th Special Forces with assets from the 160th SOAR, Alpha Company of the 75th Rangers, and the 3rd Armored Division have taken control of the Northen Airfield."]];
